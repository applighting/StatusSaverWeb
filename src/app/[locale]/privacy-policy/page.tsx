...
export const metadata: Metadata = {
  title: "Privacy Policy | Status Saver for Story Save WA",
};
    ...
    <div className="w-screen h-screen overflow-x-hidden overflow-y-scroll">
      <div className="flex-1 text-white">
        ...
        <Container className='h-full w-full flex flex-col'>
          <h1 className=" text-2xl sm:text-4xl font-bold tracking-wider">Privacy Policy</h1><br />
          ...
          <article className="text-white ">
            ...
            <h1 style={{fontSize:"34px"}}>Interpretation and Definitions</h1>
            <h2 style={{fontSize:"26px"}}>Interpretation</h2><br/>
            ...
            <h2 style={{fontSize:"26px"}}>Definitions</h2><br/>
            ...
            <ul>
              ...
              <li>
                <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Status Saver for Story Save WA</p>
              </li>
              <li>
                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Status Saver for Story Save WA.</p>
              </li>
              <li>
            ...
            <br/>
            <h1 style={{fontSize:"34px"}}>Collecting and Using Your Personal Data</h1>
            <h2 style={{fontSize:"26px"}}>Types of Data Collected</h2><br/>
            ...
            <br/>
            <h3 style={{fontSize:"26px"}}>Usage Data</h3><br/>
            ...
            <br/><h2 style={{fontSize:"26px"}}>Retention of Your Personal Data</h2><br/>
            ...
            <br/><h2 style={{fontSize:"26px"}}>Transfer of Your Personal Data</h2><br/>
            <p >Your information, including Personal Data, is processed at theCompany's operating offices and in any other places where the parties involved in the processing are located. It means that this information may be transferred to — and maintained on — computers located outside of Your state, province, country or other governmental jurisdiction where the data protection laws may differ than those from Your jurisdiction.</p>
            <p >Your consent to this Privacy Policy followed by Your submission of such information represents Your agreement to that transfer.</p>
            <p >The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in accordance with this Privacy Policy and no transfer of Your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of Your data and other personal information.</p>
            <br/><h2 style={{fontSize:"26px"}}>Disclosure of Your Personal Data</h2>
            <h3 style={{fontSize:"26px"}}>Business Transactions</h3><br/>
            <p >If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
            <br/><h3 style={{fontSize:"26px"}}>Law enforcement</h3><br/>
            <p >Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
            <br/><h3 style={{fontSize:"26px"}}>Other legal requirements</h3><br/>
            ...
            <br/><h2 style={{fontSize:"26px"}}>Security of Your Personal Data</h2><br/>
            <p >The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
            <br/><h1 style={{fontSize:"34px"}}>Detailed Information on the Processing of Your Personal Data</h1><br/>
            <p >The Service Providers We use may have access to Your Personal Data. These third-party vendors collect, store, use, process and transfer information about Your activity on Our Service in accordance with their Privacy Policies.</p>
            <br/> <h2 style={{fontSize:"26px"}}>Usage, Performance and Miscellaneous</h2><br/>
            <p >We may use third-party Service Providers to provide better improvement of our Service.</p>
            <ul ><li ><p ><strong >FreshDesk</strong></p><p >FreshDesk is a customer support software. The service is operated by Freshworks, Inc.</p><p >FreshDesk service may collect information from Your Device.</p><p >The information gathered by FreshDesk is held in accordance with its Privacy Policy:<a rel="external nofollow noopener noreferrer" target="_blank" href="https://www.freshworks.com/privacy/" >https://www.freshworks.com/privacy/</a></p></li></ul>
            <br/><h1 style={{fontSize:"34px"}}>Children's Privacy</h1><br/>
            ...
            <br/><h1 style={{fontSize:"34px"}}>Links to Other Websites</h1><br/>
            <p >Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
            <p >We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>

            <br/><h1 style={{fontSize:"34px"}}>Changes to this Privacy Policy</h1><br/>
            <p >We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page.</p>
            <p >We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective and update the "Last updated" date at the top of this Privacy Policy.</p>
            <p >You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>
            <br/><h1 style={{fontSize:"34px"}}>Contact Us</h1><br/>
            <p>If you have any questions about this Privacy Policy, You can contact us:</p>
            <ul><li><p>By email: info@statussaverwa.com</p></li><li ><p >By visiting this page on our website:<a rel="external nofollow noopener noreferrer" target="_blank" href="https://www.statussaverwa.com/" >https://www.statussaverwa.com</a></p></li></ul>
          </article>
          <br />
          <br />
          <br />
