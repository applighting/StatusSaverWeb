      ...
      <div className="flex-1 text-white">
        ...
        <Container className="h-full w-full flex flex-col">
          ...
          <article className="text-white ">
            ...
            <h2 style={{ fontSize: "26px" }}>Interpretation</h2>
            <br />
            <p>
            ...
            <br />
            <h2 style={{ fontSize: "26px" }}>Definitions</h2>
            <br />
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  device, named Status Saver for Story Save WA
                </p>
              </li>
              <li>
                <p>
            ...
            <h2 style={{ fontSize: "26px" }}>Types of Data Collected</h2>
            <br />
            <p>
            ...
            <br />
            <h3 style={{ fontSize: "26px" }}>Usage Data</h3>
            <br />
            ...
            <br />
            <h2 style={{ fontSize: "26px" }}>Use of Your Personal Data</h2>
            <br />
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  communication, such as a mobile application{'\''}spush
            ...
            <br />
            <h2 style={{ fontSize: "26px" }}>Transfer of Your Personal Data</h2>
            <br />
            <p>
              Your information, including Personal Data, is processed at
              theCompany{'\''}s operating offices and in any other places where the
            ...
            <h3 style={{ fontSize: "26px" }}>Business Transactions</h3>
            <br />
            <p>
            ...
            <br />
            <h3 style={{ fontSize: "26px" }}>Law enforcement</h3>
            <br />
            <p>
            ...
            <br />
            <h3 style={{ fontSize: "26px" }}>Other legal requirements</h3>
            <br />
            <p>
            ...
            <br />
            <h2 style={{ fontSize: "26px" }}>Security of Your Personal Data</h2>
            <br />
            <p>
            ...
            <br />
            <h1 style={{ fontSize: "34px" }}>Children{'\''}s Privacy</h1>
            <br />
            <p>
            ...
            <br />
            <h1 style={{ fontSize: "34px" }}>Links to Other Websites</h1>
            <br />
            <p>
            ...
            <br />
            <h1 style={{ fontSize: "34px" }}>Changes to this Privacy Policy</h1>
            <br />
            <p>
            ...
            <ul>
              <li>
                <p>By email: info@statussaverwa.com</p>
              </li>
              <li>
                <p>
                  ...
                  <a
                    rel="external nofollow noopener noreferrer"
                    target="_blank"
                    href="https://www.statussaverwa.com/"
                  >
                    https://www.statussaverwa.com
                  </a>
                </p>
              </li>
            </ul>
